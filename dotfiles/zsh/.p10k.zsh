# Generated by Powerlevel10k configuration wizard on 2025-10-08 at 01:44 EDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%28F'   # dark green foreground
      local	 ready='%82F'	# light green foreground
    ...
    # Don't show git status numbers
    typeset -g POWERLEVEL9K_VCS_HIDE_GIT_STATUS_NUMBERS=true
    ...
    (( VCS_STATUS_NUM_STAGED     )) && res+=" ${ready}✔"
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=105
